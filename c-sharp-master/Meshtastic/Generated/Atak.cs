...
namespace Meshtastic.Protobufs {
  ...
  #endif
  {
    ...
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public uint RangeM {
      get { if ((_hasBits0 & 1) != 0) { return rangeM_; } else { return 0; } }
      set {
        _hasBits0 |= 1;
        rangeM_ = value;
      }
  ...
  #endif
  {
    ...
    public pb::ByteString RawDetail {
      get { return payloadVariantCase_ == PayloadVariantOneofCase.RawDetail ? (pb::ByteString) payloadVariant_ : pb::ByteString.Empty; }
      set {
        payloadVariant_ = pb::ProtoPreconditions.CheckNotNull(value, "value");
    ...
    public override int GetHashCode() {
      ...
      if (payloadVariantCase_ == PayloadVariantOneofCase.RawDetail) hash ^= RawDetail.GetHashCode();
    ...
    public void WriteTo(pb::CodedOutputStream output) {
      ...
      if (payloadVariantCase_ == PayloadVariantOneofCase.RawDetail) {
